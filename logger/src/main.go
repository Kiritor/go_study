...
func init() {
	...
	TRACE = fileLogger.NewDefaultLogger("d:/log", "trace.log")
	INFO = fileLogger.NewDefaultLogger("d:/log", "info.log")
	WARN = fileLogger.NewDefaultLogger("d:/log", "warn.log")
	ERROR = fileLogger.NewDefaultLogger("d:/log", "error.log")
	...
	logFile = fileLogger.NewDefaultLogger("d:/log", "test.log")
